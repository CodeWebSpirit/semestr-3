...
namespace serializacja2
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using (FileStream s = File.Create("C:\\Users\\Student\\source\\repos\\Serializacja\\osoba.xml"))
            {
                serializer.Serialize(s, p);
                //s.Close();
            }

            using (FileStream s = File.OpenRead("C:\\Users\\Student\\source\\repos\\Serializacja\\osoba.xml"))
            {
